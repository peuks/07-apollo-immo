 ...
 */
final class Version20210217112717 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE specificity_property (specificity_id INT NOT NULL, property_id INT NOT NULL, INDEX IDX_9315C96F5F69A929 (specificity_id), INDEX IDX_9315C96F549213EC (property_id), PRIMARY KEY(specificity_id, property_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
